...
# Copy the CORRECT server code that properly handles CAPTURE_OFFSET
...
# Create startup script that shows environment variables for debugging
RUN echo '#!/bin/bash\n\
echo "Starting Enhanced ZX Spectrum Emulator Server v5..."\n\
echo "Version: 1.0.0-fixed-v5"\n\
echo "Features: Real-time key feedback, press/release support, enhanced logging"\n\
echo ""\n\
echo "Environment:"\n\
