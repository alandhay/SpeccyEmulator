...
class ImprovedSpectrumEmulator:
    def __init__(self):
    ...
    def start_ffmpeg_stream(self):
        ...
        try:
            ...
            ffmpeg_cmd = [
                ...
                '-f', 'pulse', '-i', 'default',
                '-vf', 
                "drawtext=text='v1.0.0-fixed-v3':fontcolor=yellow:fontsize=12:x=5:y=5:fontfile=/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf,"
    ...
    async def handle_websocket(self, websocket):
        ...
        try:
            ...
            await websocket.send(json.dumps({
                ...
                'message': 'Connected to ZX Spectrum Emulator v3'
            }))
    ...
    async def health_check(self, request):
        ...
        return web.json_response({
            'status': 'OK',
            'version': {
                'version': '1.0.0-fixed-v3',
                'build_time': '2025-08-02T18:05:00Z',
                'build_hash': 'fixed-v3-improved-display',
                'uptime': time.time() - self.server_start_time
            },
            'emulator_running': self.emulator_running,
    ...
    def run(self):
        ...
        logger.info("Version: 1.0.0-fixed-v3")
        logger.info("Build Time: 2025-08-02T18:05:00Z")
        logger.info("Build Hash: fixed-v3-improved-display")
        ...
        async def start_servers():
            ...
            logger.info("All services started. Server ready! Version: 1.0.0-fixed-v3")
            
            # Auto-start emulator after everything is ready
            logger.info("Auto-starting FUSE emulator with improved configuration...")
            success = self.start_emulator()
            if success:
...
if __name__ == '__main__':
    emulator = ImprovedSpectrumEmulator()
    emulator.run()
