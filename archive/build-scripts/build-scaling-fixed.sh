...
echo "Building scaling-fixed ZX Spectrum Emulator Docker image..."

# Set variables
AWS_ACCOUNT_ID="043309319786"
AWS_REGION="us-east-1"
ECR_REPOSITORY="spectrum-emulator"
IMAGE_TAG="scaling-fixed"
...
# Copy the scaling-fixed server file
cp server/emulator_server_scaling_fixed.py server/emulator_server.py

# Build the Docker image
echo "Building Docker image with scaling fixes..."
...
echo "Scaling-fixed Docker image built and pushed successfully!"
