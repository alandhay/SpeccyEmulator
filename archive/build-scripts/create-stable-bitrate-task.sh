...
# Create stable bitrate streaming task definition with minimum bitrate enforcement

cat > /tmp/stable-bitrate-task.json << 'EOF'
{
...
echo "Stable bitrate streaming task definition created!"
echo "Key improvements for YouTube streaming:"
echo "- Consistent 1500k bitrate (above YouTube's 750k minimum)"
echo "- Minimum bitrate enforced: 1000k"
echo "- Maximum bitrate: 2000k"
echo "- Forced keyframes every 2 seconds for better streaming"
echo "- Optimized for stable streaming rather than maximum quality"

# Register the new task definition
echo "Registering stable bitrate task definition..."
aws ecs register-task-definition --cli-input-json file:///tmp/stable-bitrate-task.json --region us-east-1
