...
# Copy the versioned server script
COPY emulator-server-versioned.py /app/server.py
...
# Version information
ENV VERSION=1.0.0-asyncio-fixed
ENV BUILD_TIME=2025-08-02T17:15:00Z
ENV BUILD_HASH=rev25-asyncio-fixed
